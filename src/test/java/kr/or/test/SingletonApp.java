 ...
 * Connection connection2 = dataSource.getConnection(); //   new 키워드를 사용하지 않음
 * Connection connection3 = dataSource.getConnection(); //
 * connection1 == connection2 == connection3 모두 주소값이 같음 즉, 1개의 객체만 만들고 사용합니다
 * 결과적으로 한번 DB커넥션이 성공하면, 커넥션 객체가 없어질 때까지(null) 중복으로 생성되지 않습니다.
