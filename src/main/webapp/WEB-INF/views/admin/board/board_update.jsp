        ...
        <div class="card card-primary">
          ...
          <form name="form_write" method="post" action="/admin/board/board_update" enctype="multipart/form-data">
            ...
            <div class="card-footer text-right">
              ...
              <a href="/admin/board/board_view?bno=${boardVO.bno}&page=${pageVO.page}&search_type=${pageVO.search_type}" class="btn btn-default">뷰화면</a>
            </div>
