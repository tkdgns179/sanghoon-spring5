          ...
          <form name="form_write" method="post" action="/admin/bbs_type/bbs_type_insert" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <!-- PK고유키, 식별자 중복체크 생략-->	
                <input value="" name="board_type" type="text" class="form-control" id="board_type" placeholder="게시판 타입을 입력해주세요" required style="ime-mode:disabled">
              </div>
              <div class="form-group">
                <label for="board_name">게시판 이름</label>
                <input value="" name="board_name" type="text" id="board_name" class="form-control" placeholder="게시판 이름을 입력해주세요" required>
              </div>
              <div class="form-group">
