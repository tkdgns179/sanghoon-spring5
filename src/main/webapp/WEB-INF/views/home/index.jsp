...
<script>
        ...
        $(document).ready(function () {
            ...
            var slidePlayHide = setTimeout(function () {
                $('.rollplay').css('display', 'none'); //3초 후에 rollplay 영역을 숨김
            }, 3000);
            // 3개의 슬라이드 버튼 클릭 액션 처리

            $('.rollstop').click(function () {
                // this는 클릭한 본인 태그를 가르킴
                $(this).hide(); //현재 rollstop 버튼을 숨깁니다
            ...
            $('.rollingbtn li.seq a').each(function (index) {
                $(this).click(function () {
                    ...
                    play_w(index); // 슬라이드 재생 : 단 시작위치는 클릭한 index부터
                });
            });
        });
    </script>
            ...
            <div class="main_rolling_pc">
                <div class="visualRoll">
                    ...
                    <div class="rollbtnArea">
                        <ul class="rollingbtn">
                            <!-- butt0 a img -->
                            <li class="seq butt0"><a href="#butt"><img src="/resources/home/img/btn_rollbutt_on.png" alt="1번" /></a>
                            </li>
                            <li class="seq butt1"><a href="#butt"><img src="/resources/home/img/btn_rollbutt_off.png" alt="2번" /></a>
                            </li>
                            <li class="seq butt2"><a href="#butt"><img src="/resources/home/img/btn_rollbutt_off.png" alt="3번" /></a>
                            </li>
                            <li class="rollstop"><a href="#" class="stop"><img src="/resources/home/img/btn_roll_stop.png"
                                        alt="멈춤" /></a></li>
                            <li class="rollplay"><a href="#" class="play"><img src="/resources/home/img/btn_roll_play.png"
                                        alt="재생" /></a></li>
                        </ul>
                    </div>
                    <!-- //슬라이드버튼영역 -->
                    ...
                    <ul class="place_list box_inner clear">
                        <li><a href="#"
                                ...
                                <img class="img_topplace" src="/resources/home/img/no_image.png" alt="OOOO OOOOO"
                                    style="opacity:0.7;" />
                                <h3>OOOO OOOOO</h3>
                                <p class="txt">OOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOO!
                                </p>
